...
\hypersetup{
            pdftitle={Autoreduction - an automated data reduction system for beam instruments},
            pdfauthor={J. R. Corderoy - ISIS Facility, Rutherford Appleton Laboratory - jrc91@cam.ac.uk},
            pdfborder={0 0 0},
            breaklinks=true}

...
setup(
    name="autoreduce_qp",
    version="22.0.0.dev6",  # when updating the version here make sure to also update qp_mantid_python36.D
    description="ISIS Autoreduction queue processor",
    author="ISIS Autoreduction Team",
    url="https://github.com/ISISScientificComputing/autoreduce/",
    install_requires=[
        "autoreduce_db==22.0.0.dev7", "Django==3.2.4", "fire==0.4.0", "plotly==5.1.0", "kaleido==0.2.1",
        "stomp.py==7.0.0"
    ],

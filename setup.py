...
setup(
    name="autoreduce_qp",
    version="22.0.0.dev27",  # when updating the version here make sure to also update qp_mantid_python36.D
    description="ISIS Autoreduction queue processor",
    author="ISIS Autoreduction Team",
    url="https://github.com/autoreduction/autoreduce/",
    install_requires=[
        "autoreduce_db==22.0.0.dev25", "Django>=3.2.10", "fire==0.4.0", "plotly==5.3.1", "kaleido==0.2.1",
